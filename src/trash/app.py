...
#     print("headers:", json_prettify(request.headers))
#     print("body:", json_prettify(request.body))
...
def handle_pr(payload: dict) -> dict:
    """
...
def handle_pr_sync(payload: dict) -> dict:
    """
    Stub handler for when a pull request is synchronized (new commits pushed).
...
def handle_pr_created(payload: dict) -> dict:
    """
